...
#' @return Power of the soft-thresholding Fisher's p-value combination test.
...
#' @importFrom sn psn
#'
power.soft <- function(alpha,n,tau1,eps=0,mu=0){
  power.tfisher(alpha,n,tau1,tau1,eps,mu)
}
